...
class StCatsView extends StatefulWidget {

String cat;

StCatsView({super.key,required this.cat});

  @override
  State<StCatsView> createState() => _WorkerTasksState();
}
    ...
    return InkWell(
      child: Container(
        ...
        child:Column(children: [
          ...
          (task.dateEndTask.toString().length>2)?
           Text(
            "تاريخ الانتهاء : "+task.dateEndTask.substring(0,10),
            //  "تاريخ الانتهاء : ${getFormattedDateTime(DateTime.parse(task.dateEndTask)).replaceAll('- 12:00 AM', '')}",
            style: TextStyle(
                color: secondaryTextColor,
                fontSize: 14,fontWeight:FontWeight.w400
            ),
...
class _WorkerTasksState extends State<StCatsView> {


  @override
  void initState() {
    controller.getPropWithCat(widget.cat);
    super.initState();
  }
          ...
          builder: (_) {
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                title: const Text(' فلتر حسب القسم ',
                      ...
                      child: Padding(
                        ...
                        child:GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return
                              Padding(
                                padding: const EdgeInsets.only(left:28.0,right:24,top:10,bottom:14),
                            ...
                            childAspectRatio: 1.19, // Aspect ratio of each item
                          )
                        ),
                      ),
                    ),
