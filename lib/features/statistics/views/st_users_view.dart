...
class StUsersView extends StatefulWidget {

String email;

StUsersView({super.key,required this.email});

  @override
  State<StUsersView> createState() => _WorkerTasksState();
}
...
class _WorkerTasksState extends State<StUsersView> {
  ...
  void initState() {
    ...
    controller.getPropWithUserEmail(widget.email);
          ...
          builder: (_) {
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                title: const Text(' فلتر من خلال المستخدمين ',
                      ...
                      child: Padding(
                        ...
                        child:GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return
                              Padding(
                                padding: const EdgeInsets.only(left:28.0,right:28,bottom:18),
                            ...
                            childAspectRatio:1.20, // Aspect ratio of each item
                          )
                        ),
                      ),
                    ),
