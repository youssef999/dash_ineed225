...
class UserDetails2 extends StatefulWidget {
  ...
  UserDetails2({super.key, required this.user});
  @override
  State<UserDetails2> createState() => _UserDetailsState();
}
...
class _UserDetailsState extends State<UserDetails2> {
  int numTasks = 0;
  int numTasksDone = 0;
      ...
      body: isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left:38.0,right:9,top:10,bottom:6),
                    child: _buildUserProfileCard(),
                  ),
                  const SizedBox(height: 16.0),
                  Padding(
                    padding: const EdgeInsets.only(left:28.0,right:9),
                    child: Row(
                  ...
                  const SizedBox(height: 16.0),
                  Padding(
                    padding: const EdgeInsets.only(left:38.0,right: 12),
