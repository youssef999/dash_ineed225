...
class ArabicUsersSearchScreen2 extends StatefulWidget {
  const ArabicUsersSearchScreen2({super.key});

  @override
  _ArabicUsersSearchScreenState createState() => _ArabicUsersSearchScreenState();
}

class _ArabicUsersSearchScreenState extends State<ArabicUsersSearchScreen2> {
  ...
  Future<void> fetchUsers() async {
    try {
      ...
      // Sort users locally by name in reverse alphabetical order (Z to A)
      users.sort((a, b) {
        String nameA = (a['name'] ?? '').toLowerCase();
        String nameB = (b['name'] ?? '').toLowerCase();
        return nameB.compareTo(nameA); // Reverse the comparison
      });
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // Search bar
          Padding(
            padding: const EdgeInsets.only(top: 18.0, right: 33, left: 33, bottom: 14),
            child: TextField(
          ...
          Expanded(
            child: filteredUsers.isEmpty
                ...
                : Padding(
                    padding: const EdgeInsets.only(left: 38.0, right: 11, top: 8, bottom: 8),
                    child: Column(
                      children: [
                        // Number of Users
                        Padding(
                        ...
                        Expanded(
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                padding: const EdgeInsets.only(left: 28.0, right: 10, top: 6),
