...
class ProvidersScreenAlpha extends StatefulWidget {

  const ProvidersScreenAlpha({super.key});

  @override
  _ProvidersScreenState createState() => _ProvidersScreenState();
}

class _ProvidersScreenState extends State<ProvidersScreenAlpha> {
  String _searchQuery = '';
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // Fetch and sort providers alphabetically
