...
class ProvidersWithRatingsScreen2 extends StatefulWidget {
  const ProvidersWithRatingsScreen2({super.key});

  @override
  _ProvidersWithRatingsScreenState createState() => _ProvidersWithRatingsScreenState();
}

class _ProvidersWithRatingsScreenState extends State<ProvidersWithRatingsScreen2> {
  String _searchQuery = '';
  ...
  stream: FirebaseFirestore.instance
      ...
      .orderBy('rating', descending: false) // Sort by rating in ascending order
      .snapshots(),
